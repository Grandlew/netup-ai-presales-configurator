...
class Settings:
    def __init__(self) -> None:
        ...
        self.database_url = os.getenv("DATABASE_URL", "sqlite:///./netup_presales.db")
        ...
        self.report_output_dir = Path(os.getenv("REPORT_OUTPUT_DIR", "generated_reports"))
        self.rules_path = Path(os.getenv("PRODUCT_RULES_PATH", "config/product_rules.yaml"))
